...
async function imagemDaPagina(escala) {
  ...
  if (soOQuadro || marcado) {
    ...
    /* O quadro tem rolagem interna, e exportar só a parte visível cortaria o
       conteúdo — foi para isso que o PDF foi pedido. Abre tudo e mede a
       altura de verdade, num medidor fora da tela. */
